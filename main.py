...
# SiliconFlow Client
client = OpenAI(
    api_key="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", # Make sure your key is here
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt == max_retries - 1:
                    return {"prediction": "The AI server is currently overloaded or booting up. Please try again."}
                time.sleep(2)
